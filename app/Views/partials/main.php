  ...
  <div class="az-sidebar">
    ...
    <div class="az-sidebar-body">
      <ul class="nav">
        ...
        <li class="nav-item">
          <a href="" class="nav-link with-sub main-menu-item"><i class="typcn typcn-archive"></i>Roastery</a>
          <ul class="nav-sub">
            <li class="nav-sub-item"><a href="/roastery/receive" class="nav-sub-link">Receiving Book</a></li>
          </ul>
        </li><!-- nav-item -->
        <li class="nav-item">
          <a href="" class="nav-link with-sub main-menu-item"><i class="typcn typcn-home"></i>Stores</a>
          <ul class="nav-sub">
            <li class="nav-sub-item"><a href="/inventory/grn" class="nav-sub-link">Goods Received</a></li>
            <li class="nav-sub-item"><a href="#dispatch" class="nav-sub-link">Dispatch</a></li>
          </ul>
        </li><!-- nav-item -->
        <li class="nav-item">
  ...
  <div class="az-content az-content-dashboard-two">
    ...
    <div class="az-footer ht-40">
      <div class="container-fluid pd-t-0-f ht-100p">
        <span>&copy; Coffee Enterprise Management System (CEMS) | Version 1.2</span>
