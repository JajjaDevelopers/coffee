  ...
  <div class="modal-dialog  modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="updateRoleModalLabel">Update Roles Info</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="container">
          <form action="update" class="roleForm" method='POST' id='addRoleForm'>
            <div class="row role">
              <div class="form-floating mb-3 col-md-6">
                <input type="text" class="form-control form-control-sm" id="roleName" name="role_name"
                  placeholder="Role Name">
                <label for="floatingInput" style='margin-left:10px'>Role Name</label>
              </div>
            ...
            <div class='addSection'>
                ...
                <div class="row perms">
                  <div class="form-check col-md-5 permsCheck ">
                    <input class="form-check-input permissions checkPermissions" type="checkbox"
                      value='School Management' name="perms[]" id="flexCheckChecked">
                  ...
                  <div class="form-check  col-md-5 permsCheck">
                    <input class="form-check-input checkPermissions" type="checkbox" value='Access Management'
                      name="perms[]" id="flexCheckChecked">
                    <label class="form-check-label" for="checkAll">
                      Access Management
                    </label>
                  </div>
              ...
              <div class="paraDiv">
                ...
                <div class="row perms">
                  ...
                  <div class="form-check  col-md-5 permsCheck">
                    <input class="form-check-input permissions" value='View Charts' type="checkbox" name="perms[]"
                      id="flexCheckChecked">
                    <label class="form-check-label" for="checkAll">
                      View Charts
                    </label>
                  ...
                  <!-- <div class="form-check  col-md-5 permsCheck">
                  <input class="form-check-input permissions" value='' type="checkbox" name="perms[]" id="flexCheckChecked">
                  <label class="form-check-label" for="checkAll">
                    View members
                  </label>
                </div> -->
              ...
              <div class="paraDiv">
                ...
                <div class="row perms">
                  <div class="form-check col-md-3 permsCheck">
                    <input class="form-check-input permissions" value='Add Roles' type="checkbox" name="perms[]"
                      id="flexCheckChecked">
                    <label class="form-check-label" for="schoolManagement">
                      Add Roles
                    </label>
                  ...
                  <div class="form-check  col-md-3 permsCheck">
                    <input class="form-check-input permissions" value='Edit Roles' type="checkbox" name="perms[]"
                      id="flexCheckChecked">
                    <label class="form-check-label" for="checkAll">
                      Edit Roles
                    </label>
              ...
              <div class="paraDiv">
                ...
                <div class="row perms">
                  <div class="form-check col-md-3 permsCheck">
                    <input class="form-check-input permissions" value='Add Reports' type="checkbox" name="perms[]"
                      id="flexCheckChecked">
                    <label class="form-check-label" for="schoolManagement">
                      Add Reports
                    </label>
              ...
              <div class="paraDiv">
                ...
                <div class="row perms">
                  <div class="form-check col-md-3 permsCheck">
                    <input class="form-check-input permissions" value='Add Staff' type="checkbox" name="perms[]"
                      id="flexCheckChecked">
                    <label class="form-check-label" for="schoolManagement">
                      Add Staff
                    </label>
                  ...
                  <div class="form-check  col-md-3 permsCheck">
                    <input class="form-check-input permissions" value='View Staff' type="checkbox" name="perms[]"
                      id="flexCheckChecked">
                    <label class="form-check-label" for="checkAll">
                      View Staff
                    </label>
                  ...
                  <div class="form-check  col-md-3 permsCheck">
                    <input class="form-check-input permissions" value='Edit Staff' type="checkbox" name="perms[]"
                      id="flexCheckChecked">
                    <label class="form-check-label" for="checkAll">
                      Edit Staff
                    </label>
              ...
              <div class="paraDiv">
                ...
                <div class="row perms">
                  <div class="form-check col-md-3 permsCheck">
                    <input class="form-check-input permissions" value='Add Subject' type="checkbox" name="perms[]"
                      id="flexCheckChecked">
                    <label class="form-check-label" for="schoolManagement">
                      Add Subject
                    </label>
              ...
              <div class="paraDiv">
                ...
                <div class="row perms">
                  <div class="form-check col-md-3 permsCheck">
                    <input class="form-check-input permissions" value='Add Marks' type="checkbox" name="perms[]"
                      id="flexCheckChecked">
                    <label class="form-check-label" for="schoolManagement">
                      Add Marks
                    </label>
                  ...
                  <div class="form-check  col-md-3 permsCheck">
                    <input class="form-check-input permissions" value='View Marks' type="checkbox" name="perms[]"
                      id="flexCheckChecked">
                    <label class="form-check-label" for="checkAll">
                      View Marks
                    </label>
                  ...
                  <div class="form-check  col-md-3 permsCheck">
                    <input class="form-check-input permissions" value='Edit Marks' type="checkbox" name="perms[]"
                      id="flexCheckChecked">
                    <label class="form-check-label" for="checkAll">
                      Edit Marks
                    </label>
      ...
      <div class="modal-footer update">
        ...
        <button id='updateRoleBtn' type="button" class="btn btn-primary updateBtn">Update</button>
      </div>
      </form>
    </div>
  </div>
